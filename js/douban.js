...
// 初始化豆瓣功能
function initDouban() {
    console.log("FLX助理-调试: initDouban 已调用");
    // 设置豆瓣开关的初始状态
...
function setupDoubanPagination() {
    console.log("FLX助理-调试: setupDoubanPagination 已调用");
    const prevBtn = document.getElementById('douban-prev-page');
    const nextBtn = document.getElementById('douban-next-page');
    ...
    if (prevBtn && nextBtn) {
        ...
        console.error("FLX助理-调试: 未找到分页按钮");
    }
}
...
function updatePaginationControls() {
    ...
    const currentPage = doubanPageStart / doubanPageSize + 1;
